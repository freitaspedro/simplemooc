...
@login_required
@enrollment_required
def current_announcement(request, slug, pk):
    course = request.course
    ...
    template_name = 'courses/current_announcement.html'
    context = {
        'course': course,
...
@login_required
@enrollment_required
def current_lesson(request, slug, pk):
    course = request.course
    ...
    template_name = 'courses/current_lesson.html'
    context = {
        'course': course,
        'lesson': lesson
    }
...
def material(request, slug, pk):
    ...
    if not request.user.is_staff and not material.lesson.is_available():
        messages.error(request, 'Este material não está disponível')
        return redirect('courses:lesson', slug=course.slug, pk=material.lesson.pk)
