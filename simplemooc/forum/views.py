...
class ThreadView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        if not self.request.user.is_authenticated():
            messages.error(self.request, 'Para responder ao tópico é necessário esta logado')
...
replycorrect = ReplyCorrectView.as_view()
replyincorrect = ReplyCorrectView.as_view(correct=False)
